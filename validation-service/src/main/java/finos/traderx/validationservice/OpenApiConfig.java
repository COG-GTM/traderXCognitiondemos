package finos.traderx.validationservice;
...
public class OpenApiConfig {
    ...
    @Value("${server.port}")
    private int port = 18094;

    @Bean
    public OpenAPI config() {
        Info info = new Info()
                .title("FINOS TraderX Validation Service")
                .version("0.1.0")
                .description("Centralized validation service for trades, accounts, and people");
