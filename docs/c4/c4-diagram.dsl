    ...
    model {
       trader = person "Trader" "Managing Accounts and Creating Trades" "Trader"
        ...
        tradingSystem = softwaresystem "Simple Trading System" "Allows employees to create accounts, and execute trades and view positions on these accounts." "Spring Boot Application" {
            ...
            validationService = container "Validation Service" "Centralizes validation of trades, accounts, and people" "Java and Spring Boot"
        ...
        accountService -> validationService "Validates People IDs when creating/modifying accounts" "REST/JSON/HTTP"
        ...
        validationService -> peopleService "Validates people" "REST/JSON/HTTP"
